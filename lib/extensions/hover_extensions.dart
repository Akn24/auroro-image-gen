import 'package:aurora_image_gen/ui/widgets/mouse_transforms/scale_on_hover.dart';
import 'package:aurora_image_gen/ui/widgets/mouse_transforms/translate_on_hover.dart';
...
extension HoverExtensions on Widget {
  ...
  Widget moveOnHover({double? x, double? y}) {
    return _returnUnalteredOnMobile(TranslateOnHover(x: x, y: y, child: this));
  }

  /// Scales the widget by [scale] on hover
  Widget scaleOnHover({double scale = 1.1}) {
    return _returnUnalteredOnMobile(ScaleOnHover(scale: scale, child: this));
  }
